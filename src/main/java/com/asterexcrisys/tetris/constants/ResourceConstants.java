...
public final class ResourceConstants {
    ...
    public static final String SETTINGS_VIEW = "views/settings-view.fxml";
    ...
    public static final String MAIN_THEME_TRACK = "audios/music-tracks/main-theme.mp3";
    public static final String TETROMINO_MOVED_EFFECT = "audios/sound-effects/tetromino-moved.wav";
    public static final String TETROMINO_LOCKED_EFFECT = "audios/sound-effects/tetromino-locked.wav";
    public static final String ONE_LINE_CLEARED_EFFECT = "audios/sound-effects/one-line-cleared.wav";
